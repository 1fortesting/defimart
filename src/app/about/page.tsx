...
const Section = ({ title, icon: Icon, children }: { title: string, icon: React.ElementType, children: React.ReactNode }) => (
    <div className="flex items-start gap-4">
        ...
        <div>
            <h3 className="text-xl font-bold mb-1 uppercase tracking-tight font-montserrat">{title}</h3>
            <p className="text-muted-foreground leading-relaxed font-medium font-inter">{children}</p>
        </div>
    </div>
);
        ...
        <Card className="border-none shadow-2xl rounded-[40px] overflow-hidden bg-white">
           <div className="bg-primary p-8 md:p-12 text-white text-center relative overflow-hidden">
             ...
             <CardHeader className="p-0 relative z-10">
                <CardTitle className="text-4xl md:text-5xl font-black italic uppercase tracking-tighter font-montserrat">About DEFIMART</CardTitle>
                <CardDescription className="text-white/80 text-lg mt-2 font-bold uppercase tracking-widest font-poppins">
          ...
          <CardContent className="space-y-10 p-8 md:p-12">
            ...
            <div className="bg-primary/5 border-2 border-dashed border-primary/20 p-8 rounded-[32px] text-center">
                 <p className="text-lg md:text-xl font-bold text-foreground leading-relaxed font-inter">
            ...
            <Separator className="opacity-50" />
             ...
             <div className="text-center space-y-4">
                <h3 className="text-sm font-black uppercase tracking-[4px] text-muted-foreground font-poppins">The Team</h3>
                <p className="text-muted-foreground font-medium italic font-inter">
