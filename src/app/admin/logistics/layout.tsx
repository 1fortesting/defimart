...
import { Menu, LogOut, User as UserIcon, DoorOpen, PlusCircle, Package } from 'lucide-react';
...
const navLinks = [
    { href: "/admin/logistics", text: "Products", icon: Package },
    { href: "/admin/logistics/new", text: "Add Product", icon: PlusCircle },
];
...
export default function LogisticsLayout({ children }: { children: React.ReactNode }) {
    ...
    useEffect(() => {
        const isAuthed = sessionStorage.getItem('defimart-dept-auth-logistics') === 'true';
        if (isAuthed) {
    ...
    if (showSplash) {
        return (
            <WelcomeSplash 
                ...
                message="Welcome to the Warehouse. Time to manage our inventory and product flow."
    ...
    const handleExitDepartment = () => {
        sessionStorage.removeItem('defimart-dept-auth-logistics');
