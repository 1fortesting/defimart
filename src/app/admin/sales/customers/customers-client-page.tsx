...
export default function SalesCustomersClientPage({ usersWithProfiles }: { usersWithProfiles: UserWithProfile[] }) {
        ...
        <CardContent>
            ...
            <TableBody>
                {usersWithProfiles.map((user) => (
                    <TableRow key={user.id} onClick={() => router.push(`/admin/sales/customers/${user.id}`)} className="cursor-pointer">
