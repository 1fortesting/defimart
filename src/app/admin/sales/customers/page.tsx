...
import SalesCustomersClientPage from './customers-client-page';

export default async function AdminSalesCustomersPage() {
    ...
    return <SalesCustomersClientPage usersWithProfiles={usersWithProfiles} />;
}
