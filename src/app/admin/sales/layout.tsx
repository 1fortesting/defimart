...
import { Menu, LogOut, DoorOpen, Search, TrendingUp, Package, Users, Bell } from 'lucide-react';
...
const teamMembers = [
    { name: 'Agbeke Bridget Enam', role: 'Senior Sales', fallback: 'A' },
    { name: 'Anthony', role: 'Assistant Sales', fallback: 'A' },
    { name: 'Sales Lead', role: 'Lead Contact', fallback: 'SL' },
];
        ...
        <header className="flex h-14 items-center gap-4 border-b bg-background px-4 lg:h-[60px] lg:px-6">
            <div className="md:hidden">
                <Sheet>
                    ...
                    <SheetContent side="left" className="flex flex-col p-0 w-3/4 bg-white border-r-0 shadow-2xl">
...
export default function SalesLayout({ children }: { children: React.ReactNode }) {
    ...
    const handleExitDepartment = () => {
        sessionStorage.removeItem('defimart-dept-auth-sales-department');
