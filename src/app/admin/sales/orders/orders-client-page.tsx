...
export default function AdminSalesOrdersClientPage({ initialOrders, stats }: { initialOrders: OrderWithDetails[], stats: { todaysRevenue: number, pendingOrdersCount: number } }) {
