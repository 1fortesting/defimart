...
export default function CentralAdminCustomersClientPage({ usersWithProfiles }: { usersWithProfiles: UserWithProfile[] }) {
        ...
        <CardContent>
            ...
            <TableBody>
                {usersWithProfiles.map((user) => (
                    <TableRow key={user.id} onClick={() => router.push(`/admin/central-admin/customers/${user.id}`)} className="cursor-pointer">
