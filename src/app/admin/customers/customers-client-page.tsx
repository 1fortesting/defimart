...
export default function AdminCustomersClientPage({ usersWithProfiles }: { usersWithProfiles: UserWithProfile[] }) {
        ...
        <CardContent>
            ...
            <TableBody>
                {usersWithProfiles.map((user) => (
                    <TableRow key={user.id} onClick={() => router.push(`/admin/customers/${user.id}`)} className="cursor-pointer">
