      ...
      <div className="flex items-center">
        ...
        {halfStar && (
          <div style={{ width: size, height: size, position: 'relative' }}>
              <Star style={{ width: size, height: size }} fill="hsl(var(--border))" className="text-border" />
        ...
        {[...Array(emptyStars)].map((_, i) => (
          <Star key={`empty-${i}`} fill="hsl(var(--border))" className="text-border" style={{ width: size, height: size }} />
        ))}
      </div>
